...
bool IsSignalRecent(string json)
{
    ...
    // Verificar se o sinal é mais recente que a inicialização do EA
...
void UpdatePanel()
{
    ...
    UpdateStrategyStatus("Trend", EnableTrendContinuation, lastTradeDirection != "" ? lastTradeDirection : "OFF");
